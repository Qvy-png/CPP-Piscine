...
void PmergeMe::merge_insert_sort_list( int &argc, char **argv ) {
    ...
    this->_time_list = static_cast<double>((end_list.tv_sec - start_list.tv_sec) * 1000000000 + (end_list.tv_nsec - start_list.tv_nsec)) / 1000.0;
}
...
void PmergeMe::merge_insert_sort_deque( int &argc, char **argv ) {
    ...
    this->_time_deque = static_cast<double>((end_deque.tv_sec - start_deque.tv_sec) * 1000000000 + (end_deque.tv_nsec - start_deque.tv_nsec)) / 1000.0;
}
